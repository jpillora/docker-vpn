...
if [[ $DNS ]]
then
  /opt/vpncmd localhost /SERVER /HUB:DEFAULT /CSV /CMD DhcpSet /START:192.168.30.10 /END:192.168.30.200 /MASK:255.255.255.0 /EXPIRE:72000 /GW:192.168.30.1 /DNS:${DNS} /DNS2:none /DOMAIN:none /LOG:yes
...
echo "Hub password: ${HPW}"
echo "Server password: ${SPW}"
